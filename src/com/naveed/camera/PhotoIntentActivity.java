	...
	public void onCreate(Bundle savedInstanceState) {
		...
		gallery.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent galleryIntent = new Intent(getApplicationContext(), GridViewActivity.class);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case ACTION_TAKE_PHOTO_B: {
			if (resultCode == RESULT_OK) {
				...
				Intent locationing = new Intent(this, Locationing.class);
				locationing.putExtra("imagePath", mCurrentPhotoPath);
				mCurrentPhotoPath = null;
				startActivity(locationing);
			}
			break;
		} // ACTION_TAKE_PHOTO_B
